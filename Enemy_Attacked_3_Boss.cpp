...
Enemy_State * Enemy_Attacked_3_Boss::input_state(Enemy_Basic * _Enemy, bool reverse, int targetX, int targetY)
{
	return nullptr;
}

void Enemy_Attacked_3_Boss::update(Enemy_Basic * _Enemy, int targetX, int targetY)
{
	ImageUpdateFunc(_Enemy);
}

void Enemy_Attacked_3_Boss::release(Enemy_Basic * _Enemy)
{
}

void Enemy_Attacked_3_Boss::enter_this_state(Enemy_Basic * _Enemy)
{
	_Enemy->set_Enum_State_Boss(DAMAGED_3_BOSS);

	char str[128] = "Misuzu_Attacked_3";
...
void Enemy_Attacked_3_Boss::ImageUpdateFunc(Enemy_Basic * _Enemy)
{
	frameCount++;
