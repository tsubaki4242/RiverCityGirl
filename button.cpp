...
HRESULT button::init(const char * imageName, int x, int y, POINT btnDownFramePoint, POINT btnUpFramePoint, CALLBACK_FUNCTION2 cbFunction)
{
	_callbackFunction = static_cast<CALLBACK_FUNCTION2>(cbFunction);
